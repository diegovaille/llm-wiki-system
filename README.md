...
A neighbor is scored at most as high as the direct match it came from, and at most as high as any sibling neighbor that matched the question itself, so the edge weights lift related pages above weak hits and never above the pages the question actually matched.
